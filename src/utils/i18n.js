...
export const I18N = {
  ...
  ko: {
    ...
    mode_file: '📎 파일 업로드',
    mode_text: '✍️ 직접 작성',
    text_ph: '여기에 아이디어·메모를 자유롭게 작성하세요. 선택한 스타일의 문서로 AI가 정리해 드립니다.',
    text_convert: '텍스트 변환',
    custom_prompt_ph: '예) 모든 소제목을 질문형으로 쓰고, 마지막에 3줄 요약을 넣어줘',
    stream_preview_lbl: '📡 실시간 미리보기',
    help_open: '📖 사용 가이드 보기',
    btn_home: '← 홈',
    mo_up_ttl: '업로드 및 변환',
  ...
  en: {
    ...
    tab_save: '💾 Save',
    tab_source: '📄 Source',
    tab_reconv: '🔄 Reconvert',
    tab_copy: '📋 Copy',
    src_title: '📄 Original Source',
    tab_log: '📋 Log',
    ...
    mode_text: '✍️ Write directly',
    text_ph: 'Write your ideas or notes freely here. AI will organize them into a document in the selected style.',
    text_convert: 'Convert text',
    custom_prompt_ph: 'e.g. Phrase every subheading as a question, and add a 3-line summary at the end',
    stream_preview_lbl: '📡 Live preview',
    help_open: '📖 Open user guide',
    btn_home: '← Home',
